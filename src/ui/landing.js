const CONTENT = {
  brand: "Observability Kit Node",
  strap: "runtime visibility",
  subtitle: "Monitoramento com metricas por rota, export Prometheus e logging estruturado.",
  accent: "#8cffb0",
  ctaPrimary: "Checar health",
  ctaSecondary: "Ver metricas",
  apiTitle: "Observability endpoints",
  featuresHtml: `<li><span>01</span><strong>Metrica acumulada por classe de status para leitura rapida de saude.</strong></li><li><span>02</span><strong>Exportador Prometheus pronto para dashboards e alertas.</strong></li><li><span>03</span><strong>Redacao de headers sensiveis para logs operacionais mais seguros.</strong></li>`,
  endpointsHtml: `<li><span class="method">GET</span><span class="path">/health</span></li><li><span class="method">GET</span><span class="path">/metrics</span></li><li><span class="method">GET</span><span class="path">/metrics/prometheus</span></li><li><span class="method">GET</span><span class="path">/demo/error</span></li>`,
}
